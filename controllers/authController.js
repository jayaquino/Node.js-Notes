...
const createSendToken = (user, statusCode, res) => {
  ...
  if (process.env.NODE_ENV === 'production')
    cookieOptions.secure = true; // cookie will only be sent on https
...
exports.forgotPassword = catchAsync(
  async (req, res, next) => {
    ...
    await user.save({ validateBeforeSave: false }); // Disables validation, otherwise will require email and pw
...
exports.updatePassword = catchAsync(
  async (req, res, next) => {
    ...
    user.passwordConfirm = req.body.passwordConfirm;
    await user.save();
    // User.findByIdAndUpdate will NOT work because pre middleware does not run, and validators don't run.
